        ...
        def _run_card_callback_worker() -> None:
            ...
            try:
                ...
                if isinstance(parsed_ca, dict) and str(parsed_ca.get("k") or "").strip().lower() == "rem_add_submit":
                    ...
                    time_exact = _lark_get_card_form_field(act_ca, "time_exact")
                    ...
                    if isinstance(parsed_ca, dict):
                        ...
                        if isinstance(fv_rem, dict):
                            ...
                            time_exact = time_exact or _lark_form_field_text(fv_rem.get("time_exact"))
                        ...
                        time_exact = time_exact or _lark_form_field_text(parsed_ca.get("time_exact"))
                    ...
                    time_exact = time_exact or _lark_find_field_deep(ev_ca, "time_exact")
                    ...
                    time_raw = reminder.resolve_add_reminder_form_time(
                        time_exact, time_preset, legacy_time=legacy_time
                    )
                    ...
                    if not (start_raw and end_raw and time_raw and reason):
                        send_message(
                            chat_id_ca,
                            "❌ Please fill: Start Date, End Date, Time (quick pick and/or exact), Reason.",
                        )
                        return
