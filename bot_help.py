        ...
        [
            (
                ...
                [
                    ...
                    ("/egsreply <title>⏎<reply>", "Find email by title → reply in thread", "按标题找邮件 → 原邮件内回复"),
                    ("/egsreplytest <title>⏎<reply>", "Like /egsreply but reply → junchen@ (test)", "同 /egsreply，回复发到 junchen@（测试）"),
