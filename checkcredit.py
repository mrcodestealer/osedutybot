...
Usage:
  python3 checkcredit.py --verify-headless
  python3 checkcredit.py --verify-headless --headed   # same checks, visible window
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args.verify_headless:
        ...
        print(
            "\nExample:\n  python3 checkcredit.py --verify-headless\n"
            "  python3 checkcredit.py --verify-headless --headed",
            file=sys.stderr,
        )
        return 2
